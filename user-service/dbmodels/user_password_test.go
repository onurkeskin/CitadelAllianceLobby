...
func testUserPasswordsExists(t *testing.T) {
	...
	e, err := UserPasswordExists(ctx, tx, o.ID)
	if err != nil {
...
func testUserPasswordsFind(t *testing.T) {
	...
	userPasswordFound, err := FindUserPassword(ctx, tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
var (
	userPasswordDBTypes = map[string]string{`CreatedDate`: `date`, `HashedPassword`: `character varying`, `ID`: `uuid`, `ModifiedDate`: `date`, `UserID`: `uuid`}
	_                   = bytes.MinRead
)
...
func testUserPasswordsUpdate(t *testing.T) {
	...
	if len(userPasswordColumns) == len(userPasswordPrimaryKeyColumns) {
...
func testUserPasswordsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(userPasswordColumns, userPasswordPrimaryKeyColumns) {
		fields = userPasswordColumns
	} else {
